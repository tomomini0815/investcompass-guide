...
const RakutenFxDetailed = () => {
  const features = [
    {
      title: "楽天グループのFXサービス",
      description: "楽天グループのFXサービスです。楽天グループの信頼性と実績があります。",
    ...
    {
      title: "業界標準レベルのスプレッド",
      description: "業界標準レベルのスプレッドを提供しています。コストを抑えて取引が可能です。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "取引で楽天ポイントが貯まる・使える",
      description: "取引で楽天ポイントが貯まり、使うことができます。楽天サービスを多用しているユーザーにおすすめです。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "楽天証券の「マーケットスピードFX」が利用可能",
      description: "楽天証券の「マーケットスピードFX」が利用可能です。高機能で使いやすい取引ツールです。",
      icon: <Smartphone className="h-6 w-6" />
    },
    {
      title: "楽天経済圏との連携",
      description: "楽天経済圏との連携が可能です。楽天サービスを最大限に活用できます。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "使いやすい取引ツール",
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、楽天FXの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、1,000通貨単位から取引を開始できます。取引時間は平日・祝日 7:00～21:00、土日は取引不可（口座開設・入出金のみ可能）です。"
    }
  ];
