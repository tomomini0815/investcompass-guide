...
const RakutenSecuritiesDetail = () => {
  ...
  const fees = [
    {
      ...
      fee: "55円〜",
      details: "約定代金が5万円を超える場合は、0.099%（税込）"
    },
    {
      plan: "いちにち定額コース",
      description: "国内株式現物取引（1日約定代金合計1万円まで）",
      fee: "0円",
      details: "1日約定代金合計が1万円を超える場合は、超過分に0.495%（税込）"
    },
    {
      plan: "投資信託",
      description: "手数料無料",
  ...
  const features = [
    {
      title: "楽天ポイント連携",
      description: "楽天ポイントが貯まり、利用できるのでお得に投資",
      icon: "💳"
    },
    {
      title: "投資信託積立ポイント",
      description: "投資信託の積立でも楽天ポイントが獲得可能",
      icon: "💰"
    },
    {
      title: "利便性の高いトレーディングツール",
      description: "直感的な操作性と充実した機能を備えた取引ツール",
      icon: "💻"
    },
    {
      title: "IPO取扱件数が多い",
      description: "業界トップクラスのIPO取扱件数で新規株式にアクセスしやすい",
      icon: "📈"
    }
  ];
  ...
  const tradingTools = [
    {
      name: "MARKETSPEED II",
      description: "楽天証券の主力トレーディングツール。最先端の機能と直感的な操作性を備えています。",
      image: "/images/securities/rakuten-marketspeed2.png"
    },
    {
      name: "楽天証券アプリ",
      description: "スマホでも使える楽天証券のモバイルアプリ。リアルタイムの市場情報と便利な通知機能。",
      image: "/images/securities/rakuten-app.png"
    }
  ];
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      楽天証券は、楽天グループ傘下のネット証券会社です。楽天ポイントとの連携や、
                      投資信託積立でのポイント獲得など、独自の特徴を持つ証券会社として知られています。
                    </p>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-muted-foreground text-center">
                        楽天証券の主力トレーディングツール。最先端の機能と直感的な操作性を備えています。
                      </p>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="bg-gray-200 border-2 border-dashed rounded-xl w-full h-64 flex items-center justify-center mb-4 overflow-hidden">
                      ...
                      <p className="text-muted-foreground text-center">
                        スマホでも使える楽天証券のモバイルアプリ。リアルタイムの市場情報と便利な通知機能。
                      </p>
                    </div>
                  </div>
                </CardContent>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  楽天証券は複数の手数料プランを提供しており、利用状況に応じて最適なプランを選択できます。
                </p>
              </div>
...
export default RakutenSecuritiesDetail;