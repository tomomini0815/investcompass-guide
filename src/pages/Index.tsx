  ...
  const domesticFxBrokers = [
    {
      ...
      commission: "スプレッド:米ドル/円 0.2銭原則固定",
  ...
  const internationalFxBrokers = [
    {
      ...
      commission: "米ドル/円 1.6pips（スタンダード口座）",
      minInvestment: "ドル円: -8.5/+2.5USD\nポンド円: -12.3/+3.8USD\nユーロ円: -10.2/+3.1USD",
      nisaSupport: false,
      highlight: "世界最大",
    ...
    },
    {
      ...
      commission: "米ドル/円 1.5pips（スタンダード+口座）",
      minInvestment: "ドル円: -7.8/+2.2USD\nポンド円: -11.5/+3.5USD\nユーロ円: -9.8/+2.9USD",
      nisaSupport: false,
      highlight: "仮想通貨FX",
    ...
    },
    {
      ...
      commission: "米ドル/円 1.1pips（スタンダード口座）",
      minInvestment: "ドル円: -6.9/+1.8USD\nポンド円: -10.2/+2.9USD\nユーロ円: -8.5/+2.3USD",
      nisaSupport: false,
      highlight: "低スプレッド",
