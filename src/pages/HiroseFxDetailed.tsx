...
const HiroseFxDetailed = () => {
  const features = [
    {
      ...
      description: "ヒロセ通商は、スキャルピング公認の数少ない業者です。短期的な利益を狙う取引戦略に最適です。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "54通貨ペアと非常に豊富",
      description: "ヒロセ通商では、54通貨ペアを取り扱っています。業界最多クラスの通貨ペア数で、多様な取引が可能です。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "1,000通貨単位から取引可能",
      description: "ヒロセ通商では、1,000通貨単位からの取引が可能です。少額から始められるため、FX初心者にも優しい仕様となっています。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "最速0.001秒の高速約定",
      description: "ヒロセ通商では、最速0.001秒の高速約定を実現しています。短期売買を繰り返すユーザーに最適です。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "オリジナルキャンペーンが豊富（食品プレゼントなど）",
      description: "ヒロセ通商では、オリジナルキャンペーンが豊富に用意されています。食品プレゼントなどユニークなキャンペーンも実施しています。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "スキャルピングOKの取引制限",
      description: "ヒロセ通商では、スキャルピングOKの取引制限があります。短期売買を繰り返すユーザーに最適です。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "老舗証券会社の信頼性",
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、ヒロセ通商FXの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、1,000通貨単位から取引を開始できます。取引時間は月曜日～金曜日 7:00～22:00、土曜日・日曜日・祝日 8:00～17:00です。"
    }
  ];
