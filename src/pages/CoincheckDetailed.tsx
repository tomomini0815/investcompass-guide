...
const CoincheckDetailed = () => {
  const features = [
    {
      title: "マネックスグループ傘下",
      description: "マネックスグループ傘下の取引所として、信頼性と実績があります。",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "口座開設手数料や口座維持手数料は無料",
      description: "口座開設手数料や口座維持手数料は無料です。コストをさらに抑えることができます。",
    ...
    {
      title: "スマホアプリダウンロード数国内No.1(2019年1月〜2023年12月)",
      description: "スマホアプリは、2019年1月〜2023年12月の期間で国内No.1のダウンロード数を誇っています。",
    ...
    {
      title: "NFT・IEO・INO対応",
      description: "NFT、IEO、INOなどの新しいサービスにも対応しています。",
      icon: <Coins className="h-6 w-6" />
    },
    {
      title: "多様な暗号資産の取扱",
      description: "34種類の暗号資産を取り扱っています(2025年10月時点)。",
      icon: <Coins className="h-6 w-6" />
    },
    {
      title: "販売所方式の「Taker手数料」が最大0.1％と低い",
      description: "販売所方式の「Taker手数料」が最大0.1％と低いです。コストを抑えて取引が可能です。",
  ...
  const steps = [
    {
      step: "STEP1",
      title: "メールアドレス登録",
      description: "公式サイトでメールアドレスを登録し、認証URLをクリックしてください。個人情報を入力します。"
    },
    {
      step: "STEP2",
      title: "本人確認",
      description: "「アプリでのかんたん本人確認」または「Webからの本人確認」を選択してください。スマホで本人確認書類(運転免許証・マイナンバーカードなど)と顔写真を撮影します。"
    },
    {
      step: "STEP3",
      title: "審査完了後、取引開始",
      description: "審査完了メールが届いたら即日取引可能です。日本円を入金して暗号資産を購入できます。"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Coincheckの詳細情報。販売所方式の「Taker手数料」が最大0.1％と低い、口座開設手数料や口座維持手数料は無料、信頼性の高いセキュリティ体制を提供。" />
        <meta name="keywords" content="Coincheck, 暗号資産取引所, 暗号資産比較, 手数料, 取引ツール" />
        ...
        <meta property="og:description" content="Coincheckの詳細情報。販売所方式の「Taker手数料」が最大0.1％と低い、口座開設手数料や口座維持手数料は無料、信頼性の高いセキュリティ体制を提供。" />
