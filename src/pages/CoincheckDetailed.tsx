...
const CoincheckDetailed = () => {
  const features = [
    {
      title: "販売所方式の「Taker手数料」が最大0.1％と低い",
      description: "Coincheckでは、販売所方式の「Taker手数料」が最大0.1％と、ほかの取引所より低いのが特徴です。コストを抑えて取引が可能です。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "口座開設手数料や口座維持手数料は無料",
      description: "Coincheckでは、口座開設手数料や口座維持手数料は無料です。お得に取引を始められます。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "取扱銘柄が多い",
      description: "Coincheckでは、国内主要9社の暗号資産取引所を手数料・取扱銘柄・口座開設時間などで比較されています。取扱銘柄が多く、選択肢が豊富です。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "初心者にも使いやすい",
      description: "Coincheckは初心者にも使いやすい暗号資産取引所です。直感的な操作性と充実のサポート体制で、安心してご利用いただけます。",
      icon: <Users className="h-6 w-6" />
    },
    {
      title: "日本円入金手数料が無料",
      description: "Coincheckでは、日本円の入金手数料が無料です。銀行振込の場合も無料で、コストを抑えて入金が可能です。",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "暗号資産入金手数料が無料",
      description: "Coincheckでは、暗号資産の入金手数料が無料です。コストを抑えて入金が可能です。",
  ...
  const steps = [
    {
      ...
      description: "Coincheck公式サイトから必要事項を入力してください。氏名、住所、電話番号、メールアドレスなどの基本情報と、職業、年収などの属性情報を入力します。本人確認書類（運転免許証、パスポート、マイナンバーカードのいずれか）の準備も同時に進めてください。"
    },
    {
      step: "STEP2",
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、Coincheckの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、すぐに取引を開始できます。取引時間は24時間365日です。"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Coincheck詳細 | 暗号資産取引所比較 | 投資総合ナビ</title>
        <meta name="description" content="Coincheckの詳細情報。販売所方式の「Taker手数料」が最大0.1％と低い、口座開設手数料や口座維持手数料は無料、取扱銘柄が多いを提供。" />
        <meta name="keywords" content="Coincheck, 暗号資産取引所, 取引所比較, 手数料, 取引ツール" />
        <link rel="canonical" href="https://www.toushi-navi.com/crypto/coincheck" />
        
        {/* Open Graph */}
        <meta property="og:title" content="Coincheck詳細 | 暗号資産取引所比較 | 投資総合ナビ" />
        <meta property="og:description" content="Coincheckの詳細情報。販売所方式の「Taker手数料」が最大0.1％と低い、口座開設手数料や口座維持手数料は無料、取扱銘柄が多いを提供。" />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://www.toushi-navi.com/crypto/coincheck" />
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-gradient-to-b from-muted/30 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">Coincheckの特徴</h2>
        ...
        {/* Coincheckの始め方｜簡単3ステップ */}
        <section className="py-16 bg-gradient-to-b from-background to-muted/30">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">Coincheckの始め方｜簡単3ステップ</h2>
        ...
        <section className="py-16 bg-gradient-to-b from-primary/10 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center text-primary">こんな人にCoincheckがおすすめ</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  ...
                  <span className="font-medium text-gray-800">手数料を節約したい人</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                ...
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">取扱銘柄が多いことを重視する人</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">日本円入金手数料を節約したい人</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300 md:col-span-2">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">暗号資産入金手数料を節約したい人</span>
                </div>
              </div>
            </div>
          </div>
