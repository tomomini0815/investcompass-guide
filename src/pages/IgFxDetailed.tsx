...
const IgFxDetailed = () => {
  const features = [
    {
      ...
      description: "イギリス発のグローバル業者であり、日本でも金融庁に登録済みです。国際的な信頼性と実績があります。",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "最大25倍のレバレッジ",
      description: "個人口座で最大25倍のレバレッジをかけてFX取引が可能です。少額の自己資金を元手に大量の通貨を取引することができます。",
    ...
    },
    {
      ...
      description: "約100通貨ペアを取り扱っています。マイナー通貨も含め、非常に豊富な通貨ペア数が特徴です。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "FX以外にCFD、バイナリーオプションなど多様",
      description: "FX以外にCFD、バイナリーオプションなど多様な取引商品を提供しています。多角的な投資が可能です。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "10,000通貨単位から取引可能",
      description: "10,000通貨単位からの取引が可能です。少額から始められるため、FX初心者にも優しい仕様となっています。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "ノックアウトオプションなど独自商品あり",
      description: "ノックアウトオプションなど独自の商品を提供しています。多様な取引戦略に対応できます。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "変動制で通貨ペアによって異なるスプレッド",
      description: "変動制で通貨ペアによって異なるスプレッドを提供しています。リアルタイム相場に応じた柔軟な取引が可能です。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "使いやすい取引ツール",
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、IG証券FXの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、10,000通貨単位から取引を開始できます。取引時間は平日・祝日 7:00～21:00、土日は取引不可（口座開設・入出金のみ可能）です。"
    }
  ];
