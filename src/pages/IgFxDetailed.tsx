...
const IgFxDetailed = () => {
  const features = [
    {
      title: "イギリス発のグローバル業者、日本でも金融庁登録済み",
      description: "IG証券FXは、イギリス発のグローバル業者であり、日本でも金融庁に登録済みです。国際的な信頼性と実績があります。",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "最大25倍のレバレッジ",
      description: "IG証券FXでは、個人口座で最大25倍のレバレッジをかけてFX取引が可能です。少額の自己資金を元手に大量の通貨を取引することができます。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "取引手数料完全無料",
      description: "IG証券FXでは、取引手数料が完全無料です。スプレッド以外のコストが発生しないため、低コストでの取引が可能です。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "約100通貨ペアと圧倒的な数",
      description: "IG証券FXでは、約100通貨ペアを取り扱っています。マイナー通貨も含め、非常に豊富な通貨ペア数が特徴です。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "FX以外にCFD、バイナリーオプションなど多様",
      description: "IG証券FXでは、FX以外にCFD、バイナリーオプションなど多様な取引商品を提供しています。多角的な投資が可能です。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "10,000通貨単位から取引可能",
      description: "IG証券FXでは、10,000通貨単位からの取引が可能です。少額から始められるため、FX初心者にも優しい仕様となっています。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "ノックアウトオプションなど独自商品あり",
      description: "IG証券FXでは、ノックアウトオプションなど独自の商品を提供しています。多様な取引戦略に対応できます。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "変動制で通貨ペアによって異なるスプレッド",
      description: "IG証券FXでは、変動制で通貨ペアによって異なるスプレッドを提供しています。リアルタイム相場に応じた柔軟な取引が可能です。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "使いやすい取引ツール",
  ...
  const steps = [
    {
      ...
      description: "IG証券FX公式サイトから必要事項を入力してください。氏名、住所、電話番号、メールアドレスなどの基本情報と、職業、年収などの属性情報を入力します。本人確認書類（運転免許証、パスポート、マイナンバーカードのいずれか）の準備も同時に進めてください。"
    },
    {
      step: "STEP2",
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、IG証券FXの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、10,000通貨単位から取引を開始できます。取引時間は月曜日～金曜日 7:00～21:00、土曜日・日曜日・祝日 8:00～17:00です。"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>IG証券FX詳細 | FX業者比較 | 投資総合ナビ</title>
        <meta name="description" content="IG証券FXの詳細情報。約100通貨ペアを提供、高機能な取引ツール、最大25倍のレバレッジを提供。" />
        <meta name="keywords" content="IG証券, FX業者, FX比較, 通貨ペア, 取引ツール" />
        <link rel="canonical" href="https://www.toushi-navi.com/fx/ig-fx" />
        
        {/* Open Graph */}
        <meta property="og:title" content="IG証券FX詳細 | FX業者比較 | 投資総合ナビ" />
        <meta property="og:description" content="IG証券FXの詳細情報。約100通貨ペアを提供、高機能な取引ツール、最大25倍のレバレッジを提供。" />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://www.toushi-navi.com/fx/ig-fx" />
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-gradient-to-b from-muted/30 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">IG証券FXの特徴</h2>
        ...
        <section className="py-16 bg-gradient-to-b from-background to-muted/30">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">IG証券FXの始め方｜簡単3ステップ</h2>
        ...
        <section className="py-16 bg-gradient-to-b from-primary/10 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center text-primary">こんな人にIG証券FXがおすすめ</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  ...
                  <span className="font-medium text-gray-800">マイナー通貨や多様な商品を取引したい中上級者</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">グローバル業者を利用したい方</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">ノックアウトオプションなど独自商品に興味がある方</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">多角的な投資戦略を展開したい方</span>
                </div>
