...
const MonexSecuritiesDetailPro = () => {
  ...
  const strengths = [
    ...
    },
    {
      ...
      content: [
        ...
        "IPOの完全平等抽選：IPOの配分においては、コンピュータによる完全平等抽選を導入しています。これは、申込者一人ひとりが資金量に関係なく、平等に1票として扱われる 방식です。"
      ]
    },
    {
      title: "dポイントとの連携開始",
  ...
  // 弱み・デメリット
  const weaknesses = [
    "国内株式手数料：SBI証券や楽天証券が手数料無料化に踏み切ったのに対し、マネックス証券の国内株式手数料は、1約定ごとに手数料がかかるプランが基本です。虽然, 1日の約定代金合計100万円まで手数料無料というプランもありますが, 完全に無料ではないため、国内株を頻繁に売買する投資家にとってはコスト面で不利になる可能性があります。",
    "クレカ積立のポイント還元率：マネックスカードを使った投信積立も可能ですが、ポイント還元率は最大1.1%です。SBI証券の最大5.0%（プラチナプリファード）や楽天証券の最大1.0%と比較すると、特に高還元率カードを持たない一般ユーザーにとっては、やや見劣りするかもしれません。",
    "銀行連携の弱さ：SBI証券の「SBIハイブリッド預金」や楽天証券の「マネーブリッジ」のような、預金金利が大幅にアップするような強力な銀行連携サービスはありません。資金管理の利便性や効率性の面では、大手2社に一歩譲ります。"
  ];
  ...
  const tips = [
    ...
    },
    {
      ...
      content: "日本株に投資する場合でも、まずは「銘柄スカウター」で企業のファンダメンタルズを徹底的に分析する習慣をつけましょう。「10年スクリーニング」機能を使えば、「过去10年、毎年増収増益を続けている企業」といった、長期的な成長株を簡単に見つけ出すことができます。"
    },
    {
      title: "IPOは必ず申し込む",
      ...
      <main className="flex-1">
            ...
            <div className="max-w-4xl mx-auto">
              <Card className="shadow-lg border-0 bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900">
                ...
                <CardContent className="prose max-w-none">
                  ...
                  <p className="mb-4">
                    「個人のための真のファイナンシャル・プラットフォームを創造する」という創業以来の理念のもと、投资教育コンテンツの充実にも力を入れており、단순히取引の場を提供するだけでなく、投資家を育てることにも注力しているのが特徴です。2024年にはNTTドコモとの資本業務提携を発表し、ドコモ経済圏との連携による新たな成長ステージへの期待が高まっています。
                  </p>
                  <p>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold mb-4">マネックス証券の弱み・デメリット（注意点）</h2>
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  個性的な強みを持つ一方、大手2社と比較すると見劣りする点もあります。
                </p>
              </div>
              ...
              <Card className="shadow-lg border-0 bg-gradient-to-br from-primary/10 to-secondary/10">
                ...
                <CardContent>
                  ...
                  <p className="text-muted-foreground text-center font-semibold">
                    マネックス証券は、ただ取引手数料の安さを追求するのではなく、투자家が「より良い判断を下すための武器」を提供することに価値を見出している証券会社です。知的好奇心を満たし、投資家として成長する喜びを感じたいのであれば、マネックス証券は最高の学び舎であり、最強のパートナーとなるでしょう。
                  </p>
                </CardContent>
              </Card>
            </div>
