...
const GmoCoinDetailed = () => {
  const features = [
    {
      title: "GMOグループの信頼性",
      description: "GMOコインは、GMOグループの一員として運営されており、堅実な財務基盤と実績があります。安心してご利用いただけます。",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "業界最安レベルの手数料",
      description: "GMOコインは、業界最安レベルの手数料を実現しています。コストを抑えて取引が可能です。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "日本円の出金手数料と仮想通貨の送金手数料が無料",
      description: "GMOコインでは、日本円の出金手数料と仮想通貨の送金手数料が無料です。お得に取引を進められます。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "現物取引ではマイナス手数料を導入",
      description: "GMOコインでは、現物取引においてMaker注文に対してマイナス手数料を導入しています。取引量が多いユーザーにお得です。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "アプリでの板取引がシンプル",
      description: "GMOコインのアプリでの板取引はシンプルで直感的です。初心者から上級者まで使いやすい仕様です。",
      icon: <Smartphone className="h-6 w-6" />
    },
    {
      title: "暗号資産の送金手数料が全通貨で無料",
      description: "GMOコインでは、暗号資産の送金手数料が全通貨で無料です。コストを抑えて送金が可能です。",
      icon: <Wallet className="h-6 w-6" />
    }
  ];
  ...
  const steps = [
    {
      ...
      description: "GMOコイン公式サイトから必要事項を入力してください。氏名、住所、電話番号、メールアドレスなどの基本情報と、職業、年収などの属性情報を入力します。本人確認書類（運転免許証、パスポート、マイナンバーカードのいずれか）の準備も同時に進めてください。"
    },
    {
      step: "STEP2",
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、GMOコインの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、すぐに取引を開始できます。取引時間は24時間365日です。"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>GMOコイン詳細 | 暗号資産取引所比較 | 投資総合ナビ</title>
        <meta name="description" content="GMOコインの詳細情報。GMOグループの信頼性、業界最安レベルの手数料、日本円の出金手数料と仮想通貨の送金手数料が無料を提供。" />
        <meta name="keywords" content="GMOコイン, 暗号資産取引所, 取引所比較, 手数料, 取引ツール" />
        <link rel="canonical" href="https://www.toushi-navi.com/crypto/gmo-coin" />
        
        {/* Open Graph */}
        <meta property="og:title" content="GMOコイン詳細 | 暗号資産取引所比較 | 投資総合ナビ" />
        <meta property="og:description" content="GMOコインの詳細情報。GMOグループの信頼性、業界最安レベルの手数料、日本円の出金手数料と仮想通貨の送金手数料が無料を提供。" />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://www.toushi-navi.com/crypto/gmo-coin" />
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-gradient-to-b from-muted/30 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">GMOコインの特徴</h2>
        ...
        <section className="py-16 bg-gradient-to-b from-background to-muted/30">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">GMOコインの始め方｜簡単3ステップ</h2>
        ...
        <section className="py-16 bg-gradient-to-b from-primary/10 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center text-primary">こんな人にGMOコインがおすすめ</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                ...
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300 md:col-span-2">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">初心者から上級者まで使いやすい環境を求める方</span>
                </div>
              </div>
            </div>
          </div>
