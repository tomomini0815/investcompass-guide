...
const GmoCoinDetailed = () => {
  const features = [
    {
      title: "GMOグループの信頼性",
      description: "GMOグループの一員として、信頼性と実績があります。多くのユーザーに支持されています。",
    ...
    {
      title: "すべてのサービスで手数料が無料",
      description: "すべてのサービスで手数料が無料です。コストを抑えて取引が可能です。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "ステーキングも手数料ゼロ",
      description: "ステーキングも手数料ゼロです。コストをさらに抑えることができます。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "日本円の入出金・仮想通貨の送金手数料が無料",
      description: "日本円の入出金手数料と仮想通貨の送金手数料が無料です。コストをさらに抑えることができます。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "Maker手数料がマイナス(手数料を受け取れる)",
      description: "Maker手数料がマイナスとなっており、手数料を受け取ることができます。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "多様な暗号資産の取扱",
      description: "21銘柄の暗号資産を取り扱っています(2025年11月時点)。",
  ...
  const steps = [
    {
      step: "STEP1",
      title: "メールアドレス登録",
      description: "公式サイトでメールアドレスを登録し、認証URLをクリックしてください。個人情報(氏名、生年月日、住所など)を入力します。"
    },
    {
      step: "STEP2",
      title: "本人確認",
      description: "「かんたん本人確認」を選択してください(スマホで完結)。本人確認書類(運転免許証・パスポート・マイナンバーカードなど)と顔写真をスマホで撮影します。"
    },
    {
      step: "STEP3",
      title: "審査完了後、取引開始",
      description: "最短10分で審査完了します(9時~24時の場合)。二段階認証を設定してセキュリティを強化してください。"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="GMOコインの詳細情報。GMOグループの信頼性、業界最安レベルの手数料、高機能な取引ツール、安心のセキュリティ体制を提供。" />
        <meta name="keywords" content="GMOコイン, 暗号資産取引所, 暗号資産比較, 手数料, 取引ツール" />
        ...
        <meta property="og:description" content="GMOコインの詳細情報。GMOグループの信頼性、業界最安レベルの手数料、高機能な取引ツール、安心のセキュリティ体制を提供。" />
          ...
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                ...
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">多様な暗号資産を取り扱う取引所を探している方</span>
                </div>
