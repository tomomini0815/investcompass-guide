...
const LiquidByQuoineDetailed = () => {
  const features = [
    {
      ...
      description: "Liquid by QUOINEは、国内トップクラスのセキュリティと業界最狭水準のスプレッドを兼ね備えた優秀な取引所です。資産の保護に努めています。",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "マイナーな暗号資産も取扱",
      description: "Liquid by QUOINEでは、マイナーな暗号資産も取扱っています。多様な暗号資産を取引できます。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "国内最大級の取引高",
      description: "Liquid by QUOINEは、国内最大級の取引高を持つ暗号資産取引所です。流動性が高く、スムーズな取引が可能です。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "業界最狭水準のスプレッド",
      description: "Liquid by QUOINEは、業界最狭水準のスプレッドを実現しています。コストを抑えて取引が可能です。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "レバレッジ取引に対応",
      description: "Liquid by QUOINEでは、レバレッジ取引に対応しています。差金決済取引（レバレッジ取引）をする際の取引手数料は無料です。",
      icon: <Users className="h-6 w-6" />
    },
    {
      title: "入金手数料が無料",
      description: "Liquid by QUOINEでは、入金手数料が無料です。コストを抑えて入金が可能です。",
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、Liquid by QUOINEの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、すぐに取引を開始できます。取引時間は24時間365日です。"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="keywords" content="Liquid by QUOINE, 暗号資産取引所, 取引所比較, 手数料, 取引ツール" />
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  ...
                  <span className="font-medium text-gray-800">セキュリティを重視する人</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">マイナーな暗号資産を取引したい人</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">レバレッジ取引をしたい人</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">流動性の高い取引所を求めている人</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300 md:col-span-2">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">コストを抑えて取引したい人</span>
                </div>
              </div>
            </div>
          </div>
