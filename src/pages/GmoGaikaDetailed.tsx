...
const GmoGaikaDetailed = () => {
  const features = [
    {
      title: "GMOグループの安定性",
      description: "GMO外貨は、GMOグループの一員として運営されており、堅実な財務基盤と実績があります。安心してご利用いただけます。",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "業界最狭水準のスプレッド",
      description: "GMO外貨は業界最狭水準のスプレッドを実現しています。コストを抑えて取引が可能です。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "1,000通貨単位から取引可能",
      description: "GMO外貨では、1,000通貨単位からの取引が可能です。少額から始められるため、FX初心者にも優しい仕様となっています。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "「外貨exアプリ」の評価が高い",
      description: "GMO外貨の「外貨exアプリ」は評価が高く、高機能で使いやすいスマホアプリを提供しています。外出先でも気軽に取引が可能です。",
      icon: <Smartphone className="h-6 w-6" />
    },
    {
      title: "充実した市場情報",
      description: "GMO外貨では、充実した市場情報を提供しています。最新の相場情報をすぐに確認できます。",
      icon: <Users className="h-6 w-6" />
    },
    {
      title: "取引でPayPayポイントが貯まる",
      description: "GMO外貨では、取引に応じてPayPayポイントが付与されます。お得に取引を進められます。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "条件付きスキャルピング可能",
      description: "GMO外貨では、条件付きでスキャルピング（短期取引）が可能です。短期的な利益を狙う取引戦略もご利用いただけます。",
      icon: <Zap className="h-6 w-6" />
    }
  ];
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、GMO外貨の取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、1,000通貨単位から取引を開始できます。取引時間は月曜日～金曜日 7:00～21:00、土曜日・日曜日・祝日 8:00～17:00です。"
    }
  ];
