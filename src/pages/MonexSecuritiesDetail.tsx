...
const MonexSecuritiesDetail = () => {
  // マネックス証券の基本情報
  const companyInfo = {
    name: "マネックス証券",
    fullName: "マネックス証券株式会社",
    established: "1999年12月",
    parentCompany: "マネックスグループ",
  ...
  const fees = [
    ...
    {
      plan: "一日定額手数料コース",
      description: "国内株式現物取引（1日約定代金合計100万円まで）",
      fee: "0円",
      details: "1日約定代金合計が100万円を超える場合は、超過分に0.077%（税込）"
    },
    {
      plan: "投資信託",
      description: "手数料無料",
  ...
  const features = [
    {
      title: "米国株取扱数が充実",
      description: "業界トップクラスの米国株取扱銘柄数で、多様な選択肢を提供",
      icon: "🇺🇸"
    },
    {
      title: "専用米国株アプリ",
      description: "使いやすい専用アプリで、米国株投資がより便利に",
      icon: "📱"
    },
    {
      title: "手数料水準が低い",
    ...
    {
      title: "IPO取扱件数が多い",
      description: "新規株式へのアクセスがしやすいIPO取扱件数",
      icon: "📈"
    }
  ];
  ...
  const tradingTools = [
    {
      name: "TradeStation",
      description: "マネックス証券の主力トレーディングツール。高度なチャート機能と分析ツールを備えています。",
      image: "/images/securities/monex-tradestation.png"
    },
    {
      name: "マネックス証券アプリ",
      description: "スマホでも使えるマネックス証券のモバイルアプリ。直感的な操作性とリアルタイム情報提供。",
      image: "/images/securities/monex-app.png"
    }
  ];
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      マネックス証券は、米国株投資に特化したサービスを提供するネット証券会社です。
                      米国株取扱銘柄数の多さと、使いやすい専用アプリが特徴です。
                    </p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-muted-foreground text-center">
                        スマホでも使えるマネックス証券のモバイルアプリ。直感的な操作性とリアルタイム情報提供。
                      </p>
                    </div>
                  </div>
                </CardContent>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  マネックス証券は複数の手数料プランを提供しており、利用状況に応じて最適なプランを選択できます。
                </p>
              </div>
...
export default MonexSecuritiesDetail;