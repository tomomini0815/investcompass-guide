...
const RakutenSecuritiesDetailPro = () => {
  ...
  const weaknesses = [
    ...
    "外国株の取扱国は多いが、個別銘柄のカバー範囲：米国株の取扱銘柄数は多いものの、他の専門証券会社と比較すると、中小型株やニッチな銘柄のカバー範囲は限定的。特定の国のニッチな銘柄に投資したい場合は、サブ口座として専門証券を検討する必要があるかもしれません。"
  ];
      ...
      <main className="flex-1">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold mb-4">楽天証券の弱み・デメリット（注意点）</h2>
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  ほぼ死角がないように見える楽天証券ですが、敢えて挙げるとすればいくつかの注意点が存在します。
                </p>
              </div>
