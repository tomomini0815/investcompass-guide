...
const GaitameFxDetailed = () => {
  const features = [
    {
      ...
      description: "FX専業の老舗業者であり、情報コンテンツが充実しています。マーケット情報、セミナー、レポートが豊富です。",
    ...
    },
    {
      ...
      description: "マーケット情報、セミナー、レポートが豊富に提供されています。情報収集を重視するユーザーに最適です。",
      icon: <Users className="h-6 w-6" />
    },
    {
      title: "「外貨ネクストネオ」が高機能",
      description: "取引ツール「外貨ネクストネオ」は高機能で、多彩なチャート分析機能や、直感的な操作性を備えています。",
      icon: <Smartphone className="h-6 w-6" />
    },
    {
      title: "教育コンテンツが充実しており学習環境が良好",
      description: "教育コンテンツが充実しており、学習環境が良好です。FXを学びながら取引したい初心者に最適です。",
      icon: <Users className="h-6 w-6" />
    },
    {
      title: "安心の信託保全",
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、外為どっとコムの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、1,000通貨単位から取引を開始できます。取引時間は平日・祝日 7:00～22:00、土日は取引不可（口座開設・入出金のみ可能）です。"
    }
  ];
