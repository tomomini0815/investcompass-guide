...
const DmmSecuritiesDetail = () => {
  ...
  const companyInfo = {
    ...
    fullName: "DMM.com証券株式会社",
    established: "2015年12月",
    parentCompany: "DMMグループ",
  ...
  const fees = [
    {
      ...
      fee: "55円",
      details: "1約定10万円まで110円、1日定額1,200円（上限）"
    },
    {
      plan: "投資信託",
      description: "手数料無料",
  ...
  const features = [
    {
      title: "25歳以下無料",
      description: "25歳以下の方は現物株式取引手数料が実質無料",
      icon: "🎁"
    },
    {
      title: "取引ツールが使いやすい",
      description: "直感的な操作性とシンプルなデザインの取引ツール",
      icon: "💻"
    },
    {
      title: "低コスト",
    ...
    {
      title: "即日取引開始",
      description: "最短即日から取引を開始可能で、スピーディーに投資を始められる",
      icon: "⚡"
    }
  ];
  ...
  const tradingTools = [
    {
      name: "DMM株 PRO",
      description: "DMM株のPCインストール版取引ツール。フル板サービスなど高度な機能を搭載しています。",
      image: "/images/securities/dmm-pro.png"
    },
    {
      name: "DMM株 PRO＋",
      description: "DMM株の新世代取引ツール。注文機能やチャート機能が進化したプロ仕様のツールです。",
      image: "/images/securities/dmm-pro-plus.png"
    }
  ];
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-muted-foreground text-center">
                        DMM株のPCインストール版取引ツール。フル板サービスなど高度な機能を搭載しています。
                      </p>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="bg-gray-200 border-2 border-dashed rounded-xl w-full h-64 flex items-center justify-center mb-4 overflow-hidden">
                      ...
                      <h3 className="text-xl font-bold mb-2">DMM株 PRO＋</h3>
                      <p className="text-muted-foreground text-center">
                        DMM株の新世代取引ツール。注文機能やチャート機能が進化したプロ仕様のツールです。
                      </p>
                    </div>
                  </div>
                </CardContent>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  DMM 株は低コストな手数料体系を提供しており、25歳以下の方は現物株式取引手数料が実質無料です。
                </p>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  DMM 株はすべてのNISA制度に対応しており、お得に資産運用できます。
                </p>
              </div>
