...
const DmmFxDetailed = () => {
  const features = [
    {
      ...
      description: "国内最大級の口座数を誇る大手FX業者です。信頼性と実績があり、多くのユーザーに支持されています。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "業界最狭水準のスプレッド（米ドル/円0.2銭など）",
      description: "業界最狭水準のスプレッドを実現しています。米ドル/円では原則固定0.2銭で、コストを抑えて取引が可能です。",
    ...
    },
    {
      ...
      description: "24時間対応の電話・LINEサポートを提供しています。FXに関するご質問やトラブルに対応するため、充実のサポート体制を整えています。",
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、DMM FXの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、10,000通貨単位から取引を開始できます。取引時間は平日・祝日 7:00～22:00、土日は取引不可（口座開設・入出金のみ可能）です。"
    }
  ];
