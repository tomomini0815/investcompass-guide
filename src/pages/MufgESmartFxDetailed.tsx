...
const MufgESmartFxDetailed = () => {
  const features = [
    {
      ...
      description: "三菱UFJフィナンシャル・グループの一員として運営されており、堅実な財務基盤と実績があります。安心してご利用いただけます。",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "Pontaポイント付与",
      description: "取引に応じてPontaポイントが付与されます。お得に取引を進められます。",
    ...
    {
      title: "メガバンク系の安心感",
      description: "メガバンク系の安心感があります。大手金融グループの信頼性を重視するユーザーに最適です。",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "充実したサポート体制",
      description: "充実したサポート体制を整えています。電話サポートやチャットサポートなど、複数の方法でご相談いただけます。",
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、三菱UFJ eスマート証券 FXの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、1,000通貨単位から取引を開始できます。取引時間は平日・祝日 7:00～21:00、土日は取引不可（口座開設・入出金のみ可能）です。"
    }
  ];
