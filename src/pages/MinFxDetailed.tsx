...
const MinFxDetailed = () => {
  const features = [
    {
      title: "わかりやすさと高機能の両立",
      description: "みんなのFXは、わかりやすさと高機能の両立を実現しています。初心者から上級者まで使いやすい仕様です。",
      icon: <Smartphone className="h-6 w-6" />
    },
    {
      title: "初心者向け設計",
      description: "みんなのFXは、初心者にも使いやすいように設計されています。わかりやすいナビゲーションと充実の学習コンテンツで、安心して取引を始められます。",
      icon: <Users className="h-6 w-6" />
    },
    {
      title: "取引手数料完全無料",
      description: "みんなのFXでは、取引手数料が完全無料です。スプレッド以外のコストが発生しないため、低コストでの取引が可能です。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "業界最狭水準のスプレッド",
      description: "みんなのFXは業界最狭水準のスプレッドを実現しています。コストを抑えて取引が可能です。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "1,000通貨単位から取引可能",
      description: "みんなのFXでは、1,000通貨単位からの取引が可能です。少額から始められるため、FX初心者にも優しい仕様となっています。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "高水準のスワップポイントで人気",
      description: "みんなのFXでは、高水準のスワップポイントを提供しており、長期保有する際に有利な条件となっています。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "「みんなのシストレ」で自動売買も可能",
      description: "みんなのFXでは、「みんなのシストレ」で自動売買も可能です。短期的な利益を狙う取引戦略もご利用いただけます。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "シンプルで初心者にも使いやすい取引ツール",
      description: "みんなのFXの取引ツールは、シンプルで初心者にも使いやすい設計です。初めてFXを始める方にもわかりやすく、迷わず取引を進められます。",
      icon: <Smartphone className="h-6 w-6" />
    },
    {
      title: "信頼性の高い運営会社",
      description: "みんなのFXは、トレイダーズ証券が運営しており、堅実な財務基盤と実績があります。安心してご利用いただける信頼性の高いFX業者です。",
  ...
  const steps = [
    {
      ...
      description: "みんなのFX公式サイトから必要事項を入力してください。氏名、住所、電話番号、メールアドレスなどの基本情報と、職業、年収などの属性情報を入力します。本人確認書類（運転免許証、パスポート、マイナンバーカードのいずれか）の準備も同時に進めてください。"
    },
    {
      step: "STEP2",
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、みんなのFXの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、1,000通貨単位から取引を開始できます。取引時間は月曜日～金曜日 7:00～21:00、土曜日・日曜日・祝日 8:00～17:00です。"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>みんなのFX詳細 | FX業者比較 | 投資総合ナビ</title>
        <meta name="description" content="みんなのFXの詳細情報。高水準スワップポイント、シンプルな取引画面、初心者向け設計、信頼性の高い運営会社を提供。" />
        <meta name="keywords" content="みんなのFX, トレイダーズ証券, FX業者, FX比較, スプレッド, 取引ツール" />
        <link rel="canonical" href="https://www.toushi-navi.com/fx/min-fx" />
        
        {/* Open Graph */}
        <meta property="og:title" content="みんなのFX詳細 | FX業者比較 | 投資総合ナビ" />
        <meta property="og:description" content="みんなのFXの詳細情報。高水準スワップポイント、シンプルな取引画面、初心者向け設計、信頼性の高い運営会社を提供。" />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://www.toushi-navi.com/fx/min-fx" />
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-gradient-to-b from-muted/30 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">みんなのFXの特徴</h2>
        ...
        <section className="py-16 bg-gradient-to-b from-background to-muted/30">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">みんなのFXの始め方｜簡単3ステップ</h2>
        ...
        <section className="py-16 bg-gradient-to-b from-primary/10 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center text-primary">こんな人にみんなのFXがおすすめ</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  ...
                  <span className="font-medium text-gray-800">スワップ狙いの長期投資家</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">自動売買に興味がある人</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">シンプルな取引画面を求める方</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">初心者向けの環境を求める方</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300 md:col-span-2">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">信頼性の高い運営会社を重視する方</span>
                </div>
              </div>
            </div>
          </div>
