...
const MinFxDetailed = () => {
  const features = [
    {
      title: "わかりやすさと高機能の両立",
      description: "わかりやすさと高機能の両立を実現しています。初心者から上級者まで使いやすい仕様です。",
      icon: <Smartphone className="h-6 w-6" />
    },
    {
      title: "初心者向け設計",
      description: "初心者にも使いやすいように設計されています。わかりやすいナビゲーションと充実の学習コンテンツで、安心して取引を始められます。",
    ...
    },
    {
      ...
      description: "高水準のスワップポイントを提供しており、長期保有する際に有利な条件となっています。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "「みんなのシストレ」で自動売買も可能",
      description: "「みんなのシストレ」で自動売買も可能です。短期的な利益を狙う取引戦略もご利用いただけます。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "シンプルで初心者にも使いやすい取引ツール",
      description: "取引ツールは、シンプルで初心者にも使いやすい設計です。初めてFXを始める方にもわかりやすく、迷わず取引を進められます。",
      icon: <Smartphone className="h-6 w-6" />
    },
    {
      title: "信頼性の高い運営会社",
      description: "トレイダーズ証券が運営しており、堅実な財務基盤と実績があります。安心してご利用いただける信頼性の高いFX業者です。",
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、みんなのFXの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、1,000通貨単位から取引を開始できます。取引時間は平日・祝日 7:00～21:00、土日は取引不可（口座開設・入出金のみ可能）です。"
    }
  ];
