...
const GmoClickFxDetailed = () => {
  const features = [
    {
      title: "FX取引高世界第1位の実績（※）",
      description: "GMOクリック証券FXネオは、FX取引高世界第1位の実績があります。信頼性と実績があり、多くのユーザーに支持されています。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "業界最狭水準のスプレッドを常に維持",
      description: "GMOクリック証券FXネオは、業界最狭水準のスプレッドを常に維持しています。コストを抑えて取引が可能です。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "10,000通貨単位から取引可能（南アフリカランド/円など一部は100,000通貨）",
      description: "GMOクリック証券FXネオでは、10,000通貨単位からの取引が可能です。南アフリカランド/円など一部の通貨ペアは100,000通貨単位から取引可能です。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "PC版「はっちゅう君FX+」、スマホアプリが高機能",
      description: "GMOクリック証券FXネオのPC版「はっちゅう君FX+」、スマホアプリが高機能で、多彩なチャート分析機能や、直感的な操作性を備えています。",
      icon: <Smartphone className="h-6 w-6" />
    },
    {
      title: "取引手数料完全無料",
      description: "GMOクリック証券FXネオでは、取引手数料が完全無料です。スプレッド以外のコストが発生しないため、低コストでの取引が可能です。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "高い約定力とシステムの安定性",
      description: "GMOクリック証券FXネオは、高い約定力とシステムの安定性を誇ります。取引量が多い中上級者や、システムの安定性を重視するユーザーに最適です。",
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、GMOクリック証券FXネオの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、10,000通貨単位から取引を開始できます。取引時間は月曜日～金曜日 7:00～21:00、土曜日・日曜日・祝日 8:00～17:00です。"
    }
  ];
