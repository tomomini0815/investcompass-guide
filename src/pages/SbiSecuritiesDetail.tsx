...
const SbiSecuritiesDetail = () => {
  ...
  const fees = [
    {
      plan: "スタンダードプラン",
      description: "国内株式現物取引（約定代金5万円以下）",
      fee: "55円〜",
      details: "約定代金が5万円を超える場合は、0.1%（税込）"
    },
    {
      plan: "アクティブプラン",
      description: "国内株式現物取引（約定代金合計100万円まで）",
      fee: "0円",
      details: "約定代金合計が100万円を超える場合は、超過分に0.077%（税込）"
    },
    {
      plan: "投資信託",
      description: "手数料無料",
  ...
  const features = [
    {
      title: "口座数日本一",
      description: "累計口座数が日本一で、信頼と実績を誇る証券会社",
      icon: "🏆"
    },
    {
      title: "IPO取扱件数最多",
      description: "業界最多クラスのIPO取扱件数で、新規株式にアクセスしやすい",
      icon: "📈"
    },
    {
      title: "高機能トレーディングツール",
    ...
    {
      title: "ポイント連携",
      description: "Tポイント・Vポイントなどと連携可能で、お得に投資",
      icon: "💳"
    }
  ];
  ...
  const tradingTools = [
    {
      name: "HYPER SBI 2",
      description: "SBI証券の主力トレーディングツール。高速な注文機能と充実のチャート機能を備えています。",
      image: "/images/securities/sbi-hyper-sbi2.png"
    },
    {
      name: "SBI Neo",
      description: "スマホでも使えるSBI証券のモバイルアプリ。直感的な操作性とリアルタイムの市場情報提供。",
      image: "/images/securities/sbi-neo.png"
    }
  ];
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      SBI証券は、口座数日本一を誇る老舗ネット証券会社です。手数料の安さ、
                      豊富な取扱商品、充実したサービスにより、初心者から上級者まで幅広く支持されています。
                    </p>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="flex flex-col items-center">
                      <div className="bg-gray-200 border-2 border-dashed rounded-xl w-full h-64 flex items-center justify-center mb-4">
                        <span className="text-gray-500">HYPER SBI 2 画像</span>
                      </div>
                      <h3 className="text-xl font-bold mb-2">HYPER SBI 2</h3>
                      <p className="text-muted-foreground text-center">
                        SBI証券の主力トレーディングツール。高速な注文機能と充実のチャート機能を備えています。
                      </p>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="bg-gray-200 border-2 border-dashed rounded-xl w-full h-64 flex items-center justify-center mb-4">
                        <span className="text-gray-500">SBI Neo 画像</span>
                      </div>
                      <h3 className="text-xl font-bold mb-2">SBI Neo</h3>
                      <p className="text-muted-foreground text-center">
                        スマホでも使えるSBI証券のモバイルアプリ。直感的な操作性とリアルタイムの市場情報提供。
                      </p>
                    </div>
                  </div>
                </CardContent>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  SBI証券は複数の手数料プランを提供しており、利用状況に応じて最適なプランを選択できます。
                </p>
              </div>
