...
const BybitDetailed = () => {
  const features = [
    {
      title: "業界トップの取引ペアと最安の手数料",
      description: "Bybitは業界トップの取引ペアと最安の手数料を誇る取引所です。コストを抑えて取引が可能です。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "先物・デリバティブ取引の手数料が安い",
      description: "Bybitの先物・デリバティブ取引の手数料に目を向けると、メイカー手数料がわずか0.01%と非常に安いです。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "新規登録で20USDT",
      description: "Bybitでは新規登録で20USDTのキャンペーンを実施しています。お得に取引を始められます。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "明瞭な料金体系",
      description: "Bybitの現物取引の手数料はMakerとTakerともに0.1%で、海外仮想通貨取引所の中では平均的です。",
      icon: <Users className="h-6 w-6" />
    },
    {
      title: "VIPランクによる手数料割引",
      description: "Bybitでは、30日間の取引量と資産残高に基づき手数料が段階的に割引されます。取引量が多いユーザーにお得です。",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "多様な取引オプション",
      description: "Bybitでは、現物取引だけでなく、先物・デリバティブ取引など多様な取引オプションを提供しています。",
  ...
  const steps = [
    {
      ...
      description: "Bybit公式サイトから必要事項を入力してください。氏名、住所、電話番号、メールアドレスなどの基本情報と、職業、年収などの属性情報を入力します。本人確認書類（運転免許証、パスポート、マイナンバーカードのいずれか）の準備も同時に進めてください。"
    },
    {
      step: "STEP2",
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、Bybitの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、すぐに取引を開始できます。取引時間は24時間365日です。"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Bybitの詳細情報。業界トップの取引ペアと最安の手数料、先物・デリバティブ取引の手数料が安い、新規登録で20USDTを提供。" />
        <meta name="keywords" content="Bybit, 暗号資産取引所, 取引所比較, 手数料, 取引ツール" />
        <link rel="canonical" href="https://www.toushi-navi.com/crypto/bybit" />
        
        {/* Open Graph */}
        <meta property="og:title" content="Bybit詳細 | 暗号資産取引所比較 | 投資総合ナビ" />
        <meta property="og:description" content="Bybitの詳細情報。業界トップの取引ペアと最安の手数料、先物・デリバティブ取引の手数料が安い、新規登録で20USDTを提供。" />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://www.toushi-navi.com/crypto/bybit" />
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  ...
                  <span className="font-medium text-gray-800">先物・デリバティブ取引をしたい人</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                ...
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300 md:col-span-2">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">新しいキャンペーンに興味がある人</span>
                </div>
              </div>
            </div>
          </div>
