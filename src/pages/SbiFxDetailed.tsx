...
const SbiFxDetailed = () => {
  const features = [
    {
      title: "SBIグループの信頼性",
      description: "SBIグループの一員として運営されており、堅実な財務基盤と実績があります。安心してご利用いただけます。",
    ...
    },
    {
      ...
      description: "1通貨単位からの取引が可能です。数円から取引できるため、少額から始められるため、FX初心者にも優しい仕様となっています。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "34通貨ペアと豊富",
      description: "34通貨ペアを取り扱っています。多様な通貨ペアから選べます。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "業界最狭水準のスプレッド（取引量に応じて変動）",
      description: "取引量に応じて変動する業界最狭水準のスプレッドを提供しています。コストを抑えて取引が可能です。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "積立FXサービスも提供",
      description: "積立FXサービスも提供しています。定期的な投資により、リスク分散を図ることができます。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "使いやすい取引ツール",
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、SBI FXトレードの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、1通貨単位から取引を開始できます。取引時間は平日・祝日 7:00～21:00、土日は取引不可（口座開設・入出金のみ可能）です。"
    }
  ];
