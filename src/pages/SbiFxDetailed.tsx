...
const SbiFxDetailed = () => {
  const features = [
    {
      title: "SBIグループの信頼性",
      description: "SBI FXトレードは、SBIグループの一員として運営されており、堅実な財務基盤と実績があります。安心してご利用いただけます。",
      icon: <Shield className="h-6 w-6" />
    },
    {
      title: "取引手数料完全無料",
      description: "SBI FXトレードでは、取引手数料が完全無料です。スプレッド以外のコストが発生しないため、低コストでの取引が可能です。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "1通貨から取引可能（数円から取引可能）",
      description: "SBI FXトレードでは、1通貨単位からの取引が可能です。数円から取引できるため、少額から始められるため、FX初心者にも優しい仕様となっています。",
      icon: <Zap className="h-6 w-6" />
    },
    {
      title: "34通貨ペアと豊富",
      description: "SBI FXトレードでは、34通貨ペアを取り扱っています。多様な通貨ペアから選べます。",
      icon: <Wallet className="h-6 w-6" />
    },
    {
      title: "業界最狭水準のスプレッド（取引量に応じて変動）",
      description: "SBI FXトレードでは、取引量に応じて変動する業界最狭水準のスプレッドを提供しています。コストを抑えて取引が可能です。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "積立FXサービスも提供",
      description: "SBI FXトレードでは、積立FXサービスも提供しています。定期的な投資により、リスク分散を図ることができます。",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      title: "使いやすい取引ツール",
  ...
  const steps = [
    {
      ...
      description: "SBI FXトレード公式サイトから必要事項を入力してください。氏名、住所、電話番号、メールアドレスなどの基本情報と、職業、年収などの属性情報を入力します。本人確認書類（運転免許証、パスポート、マイナンバーカードのいずれか）の準備も同時に進めてください。"
    },
    {
      step: "STEP2",
    ...
    },
    {
      ...
      description: "本人確認審査が完了すると、SBI FXトレードの取引口座が開設されます。初回入金（クレジットカードまたは銀行振込）が完了すれば、1通貨単位から取引を開始できます。取引時間は月曜日～金曜日 7:00～21:00、土曜日・日曜日・祝日 8:00～17:00です。"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>SBI FXトレード詳細 | FX業者比較 | 投資総合ナビ</title>
        <meta name="description" content="SBI FXトレードの詳細情報。業界最狭水準のスプレッド、1通貨単位から取引可能、業界最高水準のスワップポイントを提供。" />
        <meta name="keywords" content="SBI FXトレード, FX業者, FX比較, スプレッド, スワップポイント" />
        <link rel="canonical" href="https://www.toushi-navi.com/fx/sbi-fx-trade" />
        
        {/* Open Graph */}
        <meta property="og:title" content="SBI FXトレード詳細 | FX業者比較 | 投資総合ナビ" />
        <meta property="og:description" content="SBI FXトレードの詳細情報。業界最狭水準のスプレッド、1通貨単位から取引可能、業界最高水準のスワップポイントを提供。" />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://www.toushi-navi.com/fx/sbi-fx-trade" />
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-gradient-to-b from-muted/30 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">SBI FXトレードの特徴</h2>
        ...
        {/* SBI FXトレードの始め方｜簡単3ステップ */}
        <section className="py-16 bg-gradient-to-b from-background to-muted/30">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center">SBI FXトレードの始め方｜簡単3ステップ</h2>
        ...
        {/* こんな人にSBI FXトレードがおすすめ */}
        <section className="py-16 bg-gradient-to-b from-primary/10 to-background">
          <div className="container mx-auto px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-12 text-center text-primary">こんな人にSBI FXトレードがおすすめ</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  ...
                  <span className="font-medium text-gray-800">超少額から始めたい初心者</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">多様な通貨ペアを取引したい人</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                ...
                <div className="flex items-start gap-3 p-4 bg-white rounded-xl border-2 border-primary/20 shadow-md hover:shadow-lg transition-all duration-300">
                  <CheckCircle className="h-6 w-6 text-primary flex-shrink-0 mt-0.5" />
                  <span className="font-medium text-gray-800">積立FXサービスを利用したい方</span>
                </div>
