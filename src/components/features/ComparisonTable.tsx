...
const ComparisonTable = () => {
  ...
  const companies: SecurityCompany[] = [
    ...
    {
      name: "PayPay証券",
      commission: "株式購入(スマホ特化): スプレッド方式",
      minInvestment: "1,000円から購入可",
      nisaSupport: true,
      tsumitateNisa: true,
      ipoCount: 0,
      foreignStocks: true,
      points: "PayPayポイント連携など",
      rating: 4,
      affiliateUrl: "https://paypay-corp.co.jp/service/paypay-sec/",
      isDomestic: true,
      features: "スマホで少額投資 取扱銘柄は国内外主要企業中心",
    },
    {
      name: "SMBC日興証券",
      commission: "総合コース: 137円〜(10万円以下)",
      minInvestment: "原則100株",
      nisaSupport: true,
      tsumitateNisa: true,
      ipoCount: 30,
      foreignStocks: true,
      points: "Pontaポイント一部対応",
      rating: 4,
      affiliateUrl: "https://www.nikko.co.jp/",
      isDomestic: true,
      features: "大手証券系で安心感 対面取引サービスも利用可能",
    },
    {
      name: "野村證券",
      commission: "店舗型手数料は高め オンライントレードは別料金体系",
      minInvestment: "原則100株",
      nisaSupport: true,
      tsumitateNisa: true,
      ipoCount: 35,
      ...
      points: "独自ポイントなし",
      rating: 4,
      affiliateUrl: "https://www.nomura.co.jp/",
      isDomestic: true,
      features: "国内最大手証券 充実の総合サービス 店舗での対面サポート",
    },
  ];
