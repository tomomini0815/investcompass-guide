      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <Label htmlFor="initial">初期投資額</Label>
          ...
          {/* Monthly Investment */}
          <div className="space-y-3">
            <Label htmlFor="monthly">毎月の積立額</Label>
            <div className="flex items-center gap-4">
              <Input
                id="monthly"
                type="number"
                ...
                className="flex-1"
              />
              <span className="text-sm text-muted-foreground whitespace-nowrap">円/月</span>
            </div>
          </div>
      ...
      <Card id="result" className="bg-gradient-to-br from-primary/5 to-secondary/5 border-primary/20">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="text-center p-6 bg-background rounded-lg shadow-sm">
            <p className="text-sm text-muted-foreground mb-2">予想資産総額</p>
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-4 bg-background rounded-lg">
              <span className="text-sm text-muted-foreground">投資元本</span>
            ...
            <div className="flex justify-between items-center p-4 bg-secondary/10 rounded-lg">
              <span className="text-sm font-semibold text-secondary">運用益</span>
              <span className="font-bold text-secondary">{formatCurrency(result.profit)}</span>
            </div>
          </div>
